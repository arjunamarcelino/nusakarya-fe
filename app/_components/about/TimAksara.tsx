  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="container mx-auto">
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold bg-gradient-to-l from-[var(--color-nusa-blue)] to-[var(--color-deep-navy)] bg-clip-text text-transparent mb-2">
                  {member.name}
                </h3>
        ...
        {/* Values Section */}
        <div className="mt-20">
          <h3 className="text-2xl font-bold text-center bg-gradient-to-l from-[var(--color-nusa-blue)] to-[var(--color-deep-navy)] bg-clip-text text-transparent mb-12">
            Nilai-Nilai Kami
          </h3>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold bg-gradient-to-l from-[var(--color-nusa-blue)] to-[var(--color-deep-navy)] bg-clip-text text-transparent mb-2">Transparansi</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold bg-gradient-to-l from-[var(--color-nusa-blue)] to-[var(--color-deep-navy)] bg-clip-text text-transparent mb-2">Keamanan</h4>
              <p className="text-[var(--color-slate-gray)]">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold bg-gradient-to-l from-[var(--color-nusa-blue)] to-[var(--color-deep-navy)] bg-clip-text text-transparent mb-2">Komunitas</h4>
              <p className="text-[var(--color-slate-gray)]">
